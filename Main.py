...
def konversi_skala_suhu(skala_yang_dipilih, nilai_suhu, skala_yang_ingin_dikonversi):
  ...
  if skala_yang_dipilih == list_satuan_skala[0]:
    ...
    elif skala_yang_ingin_dikonversi == list_satuan_skala[2]:
      return nilai_suhu - 273.15;
    elif skala_yang_ingin_dikonversi == list_satuan_skala[3]:
      return (nilai_suhu - 273.15) * 4/5;
    elif skala_yang_ingin_dikonversi == list_satuan_skala[4]:
      return nilai_suhu * 9/5;
    elif skala_yang_ingin_dikonversi == list_satuan_skala[5]:
      return (373.15 - nilai_suhu) * 3/2;
    elif skala_yang_ingin_dikonversi == list_satuan_skala[6]:
      return (nilai_suhu - 273.15) * 33/100;
    elif skala_yang_ingin_dikonversi == list_satuan_skala[7]:
      return (nilai_suhu - 273.15) * 21/40 + 7.5;
    else:
      return;

  # Mencari nilai konversi dari satuan Fahrenheit
  elif skala_yang_dipilih == list_satuan_skala[1]:
    if skala_yang_ingin_dikonversi == list_satuan_skala[0]:
  ...
  elif skala_yang_dipilih == list_satuan_skala[2]:
    if skala_yang_ingin_dikonversi == list_satuan_skala[0]:
      return nilai_suhu + 273.15;
    elif skala_yang_ingin_dikonversi == list_satuan_skala[1]:
  ...
  elif skala_yang_dipilih == list_satuan_skala[3]:
    if skala_yang_ingin_dikonversi == list_satuan_skala[0]:
  ...
  elif skala_yang_dipilih == list_satuan_skala[4]:
    if skala_yang_ingin_dikonversi == list_satuan_skala[0]:
  ...
  elif skala_yang_dipilih == list_satuan_skala[5]:
    if skala_yang_ingin_dikonversi == list_satuan_skala[0]:
  ...
  elif skala_yang_dipilih == list_satuan_skala[6]:
    if skala_yang_ingin_dikonversi == list_satuan_skala[0]:
...
# Mencari nilai konversi dari satuan Romer
  elif skala_yang_dipilih == list_satuan_skala[7]:
    if skala_yang_ingin_dikonversi == list_satuan_skala[0]:
